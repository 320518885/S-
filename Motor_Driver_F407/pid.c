...
{
//	//6020的角度环
//	PID_Init(&Motor_pid[1],PID_POSITION_ANGLE ,10,0.05,0,8000,16384,0);  //  M6020  ID:1
//	PID_Init(&Motor_pid[2],PID_POSITION_ANGLE ,10,0.05,0,8000,16384,0);  //  M6020  ID:2
//	PID_Init(&Motor_pid[3],PID_POSITION_ANGLE ,10,0.05,0,8000,16384,0);  //  M6020  ID:3
	
	//2006的速度环
	PID_Init(&Motor_pid[0],PID_POSITION_SPEED ,10,0.1,0,8000,16384,0);  //  M2006  ID:1
	PID_Init(&Motor_pid[1],PID_POSITION_SPEED ,1,0.1,0,8000,16384,0);  //  M2006  ID:2
	PID_Init(&Motor_pid[2],PID_POSITION_SPEED ,1,0.1,0,8000,16384,0);  //  M2006  ID:3
	PID_Init(&Motor_pid[3],PID_POSITION_SPEED ,1,0.1,0,8000,16384,0);  //  M2006  ID:4
}
